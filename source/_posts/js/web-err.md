...
2)    磁盘塞满
3)    壳不支持API
4)    不兼容</td><td>较少</td></tr></tbody></table>
## 2 异常采集
...
<em><u>WHO</u></em><em> <u>did WHAT</u> and <u>get WHICH exception</u> <u>in WHICH environment</u>?</em>
...
上图为腾讯BetterJS的架构图，其中“接入层”和“推送中心”就是这里提到的接入层和消息队列。
